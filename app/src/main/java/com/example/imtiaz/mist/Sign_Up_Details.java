...
public class Sign_Up_Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign__up__details);

        sButton = findViewById(R.id.submitbtn1);
        propic = findViewById(R.id.profile_pic1);
        progressDialog = new ProgressDialog(this);
        mAuth = FirebaseAuth.getInstance();
        etfmane = findViewById(R.id.fullname1);
        etid = findViewById(R.id.roll1);
        etcontact = findViewById(R.id.mobile_no1);
        etprofession = findViewById(R.id.profession1);
        etdesignation = findViewById(R.id.designation1);
        etlocation = findViewById(R.id.location1);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Intent i = new Intent(getApplicationContext(), Create_Post.class);
                                startActivity(i);
                            }
                        }
                    });
...
//        SharedPreferences sid = this.getApplicationContext().getSharedPreferences("sid", MODE_PRIVATE);
//
//        SharedPreferences.Editor edit = sid.edit();
//
